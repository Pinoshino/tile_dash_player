...
app.controller('DashController', function($scope, sources, contributors) {
    ...
    $scope.selectedItem = {url:"http://133.9.250.223/dif-dash-content/shinohara/360_roller_movies/roller_coaster_whole_60.mpd"};
    ...
    $scope.doLoad = function () {
        ...
        //setting the time when DASH-JS runs
        var now = new Date();
        run_time = now.getTime();
        ...
        $.post("http://192.168.90.10:8080/ofc/messages",{ IPaddress:ipAddress,StartTime:StartTime,State:"null",Time:"null",Buffer:"null", Representation:"null" });
    ...
    function updateMetrics(type) {
        ...
        if (metrics && dashMetrics && $scope.streamInfo) {
          ...
          //display and save log
    	    var now = new Date();
    	    var elapsed_time = (now.getTime() - run_time)/1000;
          var out1 = document.getElementById("StartTime");
          var out2 = document.getElementById("ipaddress");
    	    var out3 = document.getElementById("Time");
    	    var out4 = document.getElementById("State");
          out1.innerHTML = StartTime;
          out2.innerHTML = ipAddress;

    	    out3.innerHTML = elapsed_time;

          // $scope.videoBitrate = 0;

    	    out4.innerHTML = state;
          ...
          // @todo 再生ボタンを押してからの経過時間だけではなく、動画の再生時間も取得できるように
          var real_time = elapsed_time - out_time[0];

          // console.log("aaaaaaaaaaaaaaaaaaa");
          // console.log(count);
          // console.log(elapsed_time);
          // console.log(out_time[0]);
          // console.log(real_time);
          // console.log("bbbbbbbbbbbbbbbbbbb");

          // @note このコードはちゃんと動いている。一旦コメントアウト
          // if (real_time >= 10 && $scope.selectedItem.url=="http://133.9.250.223/dif-dash-content/shinohara/360_movies/roller_360_90s_whole_high_2.mpd") {
          //     count = 0;
          //     $scope.selectedItem = {url:"http://133.9.250.223/dif-dash-content/shinohara/360_movies/roller_360_90s_left_up_high.mpd"};
          //     $scope.doLoad();
          // }
          //
          // if (real_time >= 20 && $scope.selectedItem.url=="http://133.9.250.223/dif-dash-content/shinohara/360_movies/roller_360_90s_left_up_high.mpd") {
          //     count = 0;
          //     $scope.selectedItem = {url:"http://133.9.250.223/dif-dash-content/shinohara/360_movies/roller_360_90s_whole_high.mpd"};
          //     $scope.doLoad();
          // }

          if (real_time >= 20 && $scope.selectedItem.url=="http://133.9.250.223/dif-dash-content/shinohara/360_roller_movies/roller_coaster_whole_0_20.mpd") {
              // count = 0;
              real_time = 0;
              $scope.selectedItem = {url:"http://133.9.250.223/dif-dash-content/shinohara/360_roller_movies/roller_coaster_whole_20_40.mpd"};
              $scope.doLoad();
          }

          if (real_time >= 20 && $scope.selectedItem.url=="http://133.9.250.223/dif-dash-content/shinohara/360_roller_movies/roller_coaster_whole_20_40.mpd") {
              // count = 0;
              real_time = 0;
              $scope.selectedItem = {url:"http://133.9.250.223/dif-dash-content/shinohara/360_roller_movies/roller_coaster_whole_40_60.mpd"};
              $scope.doLoad();
          }
        }
    }
